...
// ---------- CircuitDigest SMS ----------
const char* apiKey = "ohPg6N85uYcH";         // replace with your API key
const char* templateID = "101";              // replace with your template ID
const char* mobileNumber = "919361829942";   // your phone number
const char* var1 = "field has ";                      // optional template variables
const char* var2 = "some entrance of animals ";                      // optional template variables
